...
import {
  DEFAULT_NOSTR_PUBLIC_RELAYS,
  NOSTR_PUBLIC_MIN_PUBLISH_INTERVAL_MS,
  NOSTR_PUBLIC_PUBLISH_MAX_WAIT_MS,
  NOSTR_PUBLIC_PUBLISH_STAGGER_MS,
  NOSTR_PUBLIC_SUBSCRIPTION_MAX_WAIT_MS,
} from "./nostrRelayConfig";

export const SIMPLE_PUBLIC_RELAYS = DEFAULT_NOSTR_PUBLIC_RELAYS;
export const SIMPLE_PUBLIC_PUBLISH_MAX_WAIT_MS = NOSTR_PUBLIC_PUBLISH_MAX_WAIT_MS;
export const SIMPLE_PUBLIC_SUBSCRIPTION_MAX_WAIT_MS = NOSTR_PUBLIC_SUBSCRIPTION_MAX_WAIT_MS;
export const SIMPLE_PUBLIC_PUBLISH_STAGGER_MS = NOSTR_PUBLIC_PUBLISH_STAGGER_MS;
export const SIMPLE_PUBLIC_MIN_PUBLISH_INTERVAL_MS = NOSTR_PUBLIC_MIN_PUBLISH_INTERVAL_MS;
const SIMPLE_PUBLIC_READ_RELAYS_MAX = 3;
...
export const SIMPLE_LIVE_VOTE_BALLOT_KIND = 6431;
