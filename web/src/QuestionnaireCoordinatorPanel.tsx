...
const DEPRECATED_WORKER_RELAY_REPLACEMENTS = new Map<string, string>([
  ...
  [`wss://offchain.${"pub"}`, "wss://nos.lol"],
  ["wss://relay.nostr.band", "wss://relay.nostr.net"],
  ...
  ["wss://relay.nostr.info", "wss://relay.nostr.net"],
  ["wss://nip17.com", "wss://nos.lol"],
  ["wss://relay.layer.systems", "wss://relay.nostr.net"],
  ["wss://nostr.bond", "wss://nos.lol"],
  ["wss://auth.nostr1.com", "wss://relay.nostr.net"],
  ["wss://inbox.nostr.wine", "wss://nos.lol"],
