...
- **NIP-17 gift-wrapped DMs** for follow, issuance, lead-forwarded ticket delivery, and acknowledgement traffic
...
- blind issuance responses, with non-lead shares forwarded through the lead coordinator
- acknowledgements
...
sequenceDiagram
  ...
  C->>L: Send sub-share to lead (DM)
  L->>V: Forward sub-share to voter (DM)
