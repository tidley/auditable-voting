...
While a questionnaire is live, results show locally verified accepted votes. After a public result summary covers the loaded responses, Organiser and Observer show that published tally instead of adding a live tally over it.
