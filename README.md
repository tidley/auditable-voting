...
- Blind credential issuance for invited participants. New questionnaires publish per-question ballot slots; voters request a bundle of scoped blind credentials, submit one question at a time, and answer-list changes bump that question slot version so old credentials cannot be spent against the edited slot.
