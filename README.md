...
- `WORKER_DM_RELAYS` for NIP-17/private worker DMs; defaults to `wss://vm-1734.lnvps.cloud/,wss://relay.nostr.net,wss://nip17.com,wss://relay.0xchat.com`. Keep public-only or rate-limited relays such as `wss://relay.nostr.info`, `wss://nos.lol`, `wss://relay.damus.io`, and `wss://relay.primal.net` out of this list for live sessions.
